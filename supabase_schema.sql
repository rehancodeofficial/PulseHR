-- Supabase/PostgreSQL schema for PulseHR
...
END $$;
DO $$ BEGIN CREATE TYPE "EmploymentStatus" AS ENUM (
    'active',
    'on_leave',
    'probation',
    'terminated',
...
WHEN duplicate_object THEN NULL;
END $$;
DO $$ BEGIN CREATE TYPE "AttendanceStatus" AS ENUM ('present', 'absent', 'leave', 'late', 'half_day');
EXCEPTION
WHEN duplicate_object THEN NULL;
END $$;
DO $$ BEGIN CREATE TYPE "LeaveType" AS ENUM ('annual', 'sick', 'casual', 'emergency');
EXCEPTION
WHEN duplicate_object THEN NULL;
END $$;
DO $$ BEGIN CREATE TYPE "LeaveStatus" AS ENUM ('pending', 'approved', 'rejected');
EXCEPTION
WHEN duplicate_object THEN NULL;
END $$;
...
WHEN duplicate_object THEN NULL;
END $$;
DO $$ BEGIN CREATE TYPE "TaskPriority" AS ENUM ('low', 'medium', 'high', 'critical');
EXCEPTION
WHEN duplicate_object THEN NULL;
END $$;
DO $$ BEGIN CREATE TYPE "TaskStatus" AS ENUM ('todo', 'in_progress', 'review', 'done');
EXCEPTION
WHEN duplicate_object THEN NULL;
END $$;
DO $$ BEGIN CREATE TYPE "AssetCategory" AS ENUM (
    'laptop',
    'monitor',
    'keyboard',
    'mouse',
...
WHEN duplicate_object THEN NULL;
END $$;
DO $$ BEGIN CREATE TYPE "AssetStatus" AS ENUM (
    'available',
    'assigned',
    'maintenance',
    'retired'
...
WHEN duplicate_object THEN NULL;
END $$;
DO $$ BEGIN CREATE TYPE "NotificationKind" AS ENUM (
    'leave',
    'task',
    'attendance',
    'project',
...
WHEN duplicate_object THEN NULL;
END $$;
DO $$ BEGIN CREATE TYPE "AuthTokenType" AS ENUM ('password_reset', 'email_verification');
EXCEPTION
WHEN duplicate_object THEN NULL;
END $$;
...
DO $$ BEGIN IF NOT EXISTS (
    SELECT 1
    FROM pg_constraint
    WHERE conname = 'departments_managerId_fkey'
) THEN
ALTER TABLE "departments"
ADD CONSTRAINT "departments_managerId_fkey" FOREIGN KEY ("managerId") REFERENCES "employees"("id") ON DELETE
...
ADD CONSTRAINT "employees_departmentId_fkey" FOREIGN KEY ("departmentId") REFERENCES "departments"("id") ON DELETE
SET NULL ON UPDATE CASCADE;
END IF;
END $$;
DO $$ BEGIN IF NOT EXISTS (
    SELECT 1
    FROM pg_constraint
    WHERE conname = 'user_credentials_employeeId_fkey'
) THEN
ALTER TABLE "user_credentials"
ADD CONSTRAINT "user_credentials_employeeId_fkey" FOREIGN KEY ("employeeId") REFERENCES "employees"("id") ON DELETE CASCADE ON UPDATE CASCADE;
END IF;
END $$;
DO $$ BEGIN IF NOT EXISTS (
    SELECT 1
    FROM pg_constraint
    WHERE conname = 'refresh_tokens_employeeId_fkey'
) THEN
ALTER TABLE "refresh_tokens"
ADD CONSTRAINT "refresh_tokens_employeeId_fkey" FOREIGN KEY ("employeeId") REFERENCES "employees"("id") ON DELETE CASCADE ON UPDATE CASCADE;
END IF;
END $$;
DO $$ BEGIN IF NOT EXISTS (
    SELECT 1
    FROM pg_constraint
    WHERE conname = 'auth_tokens_employeeId_fkey'
) THEN
ALTER TABLE "auth_tokens"
ADD CONSTRAINT "auth_tokens_employeeId_fkey" FOREIGN KEY ("employeeId") REFERENCES "employees"("id") ON DELETE CASCADE ON UPDATE CASCADE;
END IF;
END $$;
DO $$ BEGIN IF NOT EXISTS (
    SELECT 1
...
DO $$ BEGIN IF NOT EXISTS (
    SELECT 1
    FROM pg_constraint
    WHERE conname = 'leave_requests_employeeId_fkey'
) THEN
ALTER TABLE "leave_requests"
ADD CONSTRAINT "leave_requests_employeeId_fkey" FOREIGN KEY ("employeeId") REFERENCES "employees"("id") ON DELETE CASCADE ON UPDATE CASCADE;
END IF;
END $$;
DO $$ BEGIN IF NOT EXISTS (
    SELECT 1
    FROM pg_constraint
    WHERE conname = 'leave_requests_decidedById_fkey'
) THEN
ALTER TABLE "leave_requests"
ADD CONSTRAINT "leave_requests_decidedById_fkey" FOREIGN KEY ("decidedById") REFERENCES "employees"("id") ON DELETE
SET NULL ON UPDATE CASCADE;
END IF;
END $$;
DO $$ BEGIN IF NOT EXISTS (
    SELECT 1
    FROM pg_constraint
    WHERE conname = 'leave_balances_employeeId_fkey'
) THEN
ALTER TABLE "leave_balances"
ADD CONSTRAINT "leave_balances_employeeId_fkey" FOREIGN KEY ("employeeId") REFERENCES "employees"("id") ON DELETE CASCADE ON UPDATE CASCADE;
END IF;
END $$;
DO $$ BEGIN IF NOT EXISTS (
    SELECT 1
    FROM pg_constraint
    WHERE conname = 'project_members_projectId_fkey'
) THEN
...
DO $$ BEGIN IF NOT EXISTS (
    SELECT 1
    FROM pg_constraint
    WHERE conname = 'project_members_employeeId_fkey'
) THEN
ALTER TABLE "project_members"
ADD CONSTRAINT "project_members_employeeId_fkey" FOREIGN KEY ("employeeId") REFERENCES "employees"("id") ON DELETE CASCADE ON UPDATE CASCADE;
END IF;
END $$;
DO $$ BEGIN IF NOT EXISTS (
    SELECT 1
    FROM pg_constraint
    WHERE conname = 'tasks_projectId_fkey'
) THEN
ALTER TABLE "tasks"
...
DO $$ BEGIN IF NOT EXISTS (
    SELECT 1
    FROM pg_constraint
    WHERE conname = 'tasks_assigneeId_fkey'
) THEN
ALTER TABLE "tasks"
ADD CONSTRAINT "tasks_assigneeId_fkey" FOREIGN KEY ("assigneeId") REFERENCES "employees"("id") ON DELETE CASCADE ON UPDATE CASCADE;
END IF;
END $$;
DO $$ BEGIN IF NOT EXISTS (
    SELECT 1
    FROM pg_constraint
    WHERE conname = 'assets_assignedTo_fkey'
) THEN
ALTER TABLE "assets"
ADD CONSTRAINT "assets_assignedTo_fkey" FOREIGN KEY ("assignedTo") REFERENCES "employees"("id") ON DELETE
SET NULL ON UPDATE CASCADE;
END IF;
END $$;
DO $$ BEGIN IF NOT EXISTS (
    SELECT 1
    FROM pg_constraint
    WHERE conname = 'documents_employeeId_fkey'
) THEN
ALTER TABLE "documents"
ADD CONSTRAINT "documents_employeeId_fkey" FOREIGN KEY ("employeeId") REFERENCES "employees"("id") ON DELETE CASCADE ON UPDATE CASCADE;
END IF;
END $$;
DO $$ BEGIN IF NOT EXISTS (
    SELECT 1
    FROM pg_constraint
    WHERE conname = 'documents_uploadedById_fkey'
) THEN
ALTER TABLE "documents"
ADD CONSTRAINT "documents_uploadedById_fkey" FOREIGN KEY ("uploadedById") REFERENCES "employees"("id") ON DELETE
SET NULL ON UPDATE CASCADE;
END IF;
END $$;
DO $$ BEGIN IF NOT EXISTS (
...
ADD CONSTRAINT "notification_recipients_notificationId_fkey" FOREIGN KEY ("notificationId") REFERENCES "notifications"("id") ON DELETE CASCADE ON UPDATE CASCADE;
END IF;
END $$;
DO $$ BEGIN IF NOT EXISTS (
    SELECT 1
    FROM pg_constraint
    WHERE conname = 'notification_recipients_employeeId_fkey'
) THEN
ALTER TABLE "notification_recipients"
ADD CONSTRAINT "notification_recipients_employeeId_fkey" FOREIGN KEY ("employeeId") REFERENCES "employees"("id") ON DELETE CASCADE ON UPDATE CASCADE;
END IF;
END $$;
DO $$ BEGIN IF NOT EXISTS (
    SELECT 1
    FROM pg_constraint
    WHERE conname = 'audit_logs_actorId_fkey'
) THEN
ALTER TABLE "audit_logs"
ADD CONSTRAINT "audit_logs_actorId_fkey" FOREIGN KEY ("actorId") REFERENCES "employees"("id") ON DELETE
SET NULL ON UPDATE CASCADE;
END IF;
END $$;
DO $$ BEGIN IF NOT EXISTS (
    SELECT 1
    FROM pg_constraint
    WHERE conname = 'notification_preferences_employeeId_fkey'
) THEN
ALTER TABLE "notification_preferences"
ADD CONSTRAINT "notification_preferences_employeeId_fkey" FOREIGN KEY ("employeeId") REFERENCES "employees"("id") ON DELETE CASCADE ON UPDATE CASCADE;
END IF;
END $$;
CREATE OR REPLACE FUNCTION public.set_updated_at() RETURNS trigger AS $$ BEGIN NEW."updatedAt" = CURRENT_TIMESTAMP;
RETURN NEW;
END;
$$ LANGUAGE plpgsql;
DROP TRIGGER IF EXISTS "set_departments_updated_at" ON "departments";
CREATE TRIGGER "set_departments_updated_at" BEFORE
UPDATE ON "departments" FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();
DROP TRIGGER IF EXISTS "set_employees_updated_at" ON "employees";
CREATE TRIGGER "set_employees_updated_at" BEFORE
UPDATE ON "employees" FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();
DROP TRIGGER IF EXISTS "set_user_credentials_updated_at" ON "user_credentials";
CREATE TRIGGER "set_user_credentials_updated_at" BEFORE
UPDATE ON "user_credentials" FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();
DROP TRIGGER IF EXISTS "set_attendance_records_updated_at" ON "attendance_records";
CREATE TRIGGER "set_attendance_records_updated_at" BEFORE
UPDATE ON "attendance_records" FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();
DROP TRIGGER IF EXISTS "set_leave_balances_updated_at" ON "leave_balances";
CREATE TRIGGER "set_leave_balances_updated_at" BEFORE
UPDATE ON "leave_balances" FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();
DROP TRIGGER IF EXISTS "set_projects_updated_at" ON "projects";
CREATE TRIGGER "set_projects_updated_at" BEFORE
UPDATE ON "projects" FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();
DROP TRIGGER IF EXISTS "set_tasks_updated_at" ON "tasks";
CREATE TRIGGER "set_tasks_updated_at" BEFORE
UPDATE ON "tasks" FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();
DROP TRIGGER IF EXISTS "set_assets_updated_at" ON "assets";
CREATE TRIGGER "set_assets_updated_at" BEFORE
UPDATE ON "assets" FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();
DROP TRIGGER IF EXISTS "set_company_settings_updated_at" ON "company_settings";
CREATE TRIGGER "set_company_settings_updated_at" BEFORE
UPDATE ON "company_settings" FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();
DROP TRIGGER IF EXISTS "set_notification_preferences_updated_at" ON "notification_preferences";
CREATE TRIGGER "set_notification_preferences_updated_at" BEFORE
UPDATE ON "notification_preferences" FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();
INSERT INTO "company_settings" ("id")
VALUES ('company') ON CONFLICT ("id") DO NOTHING;
-- Quick verification: this should return all tables as true after this script runs.
SELECT to_regclass('public.employees') IS NOT NULL AS employees_exists,
